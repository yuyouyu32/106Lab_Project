...
if __name__ == '__main__':
    datatransformer = DataTransform(
        data_path='./test.csv', save_path='./')
    original_data = datatransformer.generate_original_img(
        chemical_compositions=['Fe', 'C', 'O', 'Ti'])
    pic_1 = datatransformer.generate_img(img_template_path = './ImgTemplate.xlsx', chemical_compositions=['Fe', 'C', 'O', 'Ti'])
    transfet_img(img_path = './Images.csv', save_path = './pics_1', save_prename = 'test')
    pic_2 = datatransformer.generate_img(img_template_path = './PICTURE.xlsx', chemical_compositions=['Fe', 'C', 'O', 'Ti'])
